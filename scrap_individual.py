...
# Keyword categories
categories = {
    'opositores': {'oposicion', 'adrian oliva', 'anez', 'carolina ribera', 'carlos mesa',
    ...
    'masistas': {'adriana salvatierra', 'andronico', 'choquehuanca', 'cuellar', 'del castillo',
                'diego pary', 'eva copa', 'evo', 'evo morales', 'felix patzi', 'gabriela zapata',
                'garcia linera', 'jhonny fernandez', 'luis arce', 'arce', 'marcelo montenegro',
                'nelida sifuentes', 'romero', 'torrico', 'edmundo novillo', 'wilfredo chavez'},
    
    'economia': {'aduana', 'aguinaldo', 'anh', 'bono', 'cañeros', 'capitalizacion',
                'combustible', 'combustibles', 'comercio exterior', 'deficit',
                'deuda externa', 'diesel', 'dolares', 'economia', 'etanol', 'gasolina',
                'industrializacion', 'informalidad', 'jubilacion', 'mineria', 'pge',
                'presupuesto', 'recursos', 'subsidio', 'subvencion', 'ypfb'},
    
    'narcotrafico': {'antidroga', 'coca', 'cocaina', 'chapare', 'droga', 'fabrica de droga',
                'felcn', 'marihuana', 'narcotraficante', 'narcotrafico', 'pcc', 'sello rojo',
                'sebastian marset', 'tropico de cochabamba', 'marset'},
    
    'politica': {'consejales', 'constitucion', 'corrupto', 'corrupcion', 'csutcb', 'diputado',
                'diputados', 'elecciones', 'electoral', 'estabilidad', 'exministros', 'gobierno',
                'golpe de estado', 'MAS', 'masistas', 'ministro', 'opositores', 'parlamento',
                'procuradoria', 'referendum', 'revocatorio', 'revocatoria', 'senado', 'senadores',
                'tse', 'viceministro', 'voto'},
    
    'seguridad': {'abuso sexual', 'armas', 'asesinato', 'blindado', 'carcel', 'capturado',
                'capturaron', 'chonchocoro', 'desaparecida', 'derrame', 'explosivo',
                'feminicidio', 'fuego', 'fusiles', 'incendios', 'interpol', 'ladron',
                'ladrones', 'muerte', 'organizacion criminal', 'organizaciones criminales',
                'palmasola', 'policia', 'prision', 'robar', 'robo', 'secuestro', 'seguridad',
                'sequias', 'trata'}
}
...
for url in urls:
    ...
    try:
        ...
        ignore_words = {'que', 'con', 'por', 'los', 'del', 'una', 'para', 'las', 'pero', 'como', 'the',
                        ...
                        'diciembre', 'noviembre', 'octubre', 'marcas', 'unitel', 'tendencias', 'telepais', 'batidora'
